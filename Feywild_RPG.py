...
class Enemy(Character):
    def __init__(self, name, strength, dexterity, constitution, intelligence, wisdom, charisma, hp):
        super().__init__(name, "Enemy", "Monster", strength, dexterity, constitution, intelligence, wisdom, charisma, hp)
...
world_map = {
    "Grove": {
        ...
        "east": "Path",
        "west": "Dark Grove",
        "encounters": ["Corrupted Sprite", "Wild Boar"],
        "npcs": ["Faelar", "Sylvane"]
    },
    "Thicket": {
        ...
        "south": "Grove",
        "east": "Ruins",
        "encounters": ["Shadow Wolf", "Twisted Treant"],
        "npcs": []
    },
    "Path": {
...
def create_enemy(enemy_name):
    if enemy_name == "Corrupted Sprite":
        return Enemy("Corrupted Sprite", 8, 12, 8, 10, 8, 6, 15)
    elif enemy_name == "Shadow Wolf":
        return Enemy("Shadow Wolf", 14, 14, 12, 6, 10, 8, 30)
    elif enemy_name == "Wild Boar":
        return Enemy("Wild Boar", 16, 10, 14, 4, 8, 6, 25)
    elif enemy_name == "Twisted Treant":
        return Enemy("Twisted Treant", 18, 8, 18, 6, 8, 6, 40)
    else:
        return Enemy("Unknown Enemy", 10, 10, 10, 10, 10, 10, 20)
...
def generate_quest():
    ...
    if quest_type == "Retrieve":
        ...
        monster = random.choice(["Corrupted Sprite", "Shadow Wolf", "Twisted Treant"])
...
def generate_city():
    ...
    # Add shop generation logic here
    # Add city quest generation logic here
    return city
...
def main():
    ...
    city = generate_city() #generate a city.
    ...
    while True:
        ...
        if choice == "1":
            ...
            enemy = create_enemy(random.choice(["Corrupted Sprite", "Shadow Wolf", "Wild Boar", "Twisted Treant"]))
            combat(player, enemy)
        elif choice == "5":
